...
(define-minor-mode arrow-mode nil
  ...
  :keymap `((,(kbd "<M-down>")       . arrow-window-increase-height)
            ...
            (,(kbd "ESC <down>")    . arrow-window-increase-height)
            (,(kbd "ESC <up>")      . arrow-window-decrease-height)
            (,(kbd "ESC <right>")   . arrow-window-increase-width)
            (,(kbd "ESC <left>")    . arrow-window-decrease-width)
